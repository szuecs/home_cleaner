...
PKG_NAME      = 'home_cleaner'
PKG_VERSION   = HomeCleaner::VERSION
...
PKG_FILES     = Dir.glob("{bin,config,launchd}/**/*") | Dir.glob("lib/**/*.rb") | ["README.rdoc", "LICENSE", "CHANGELOG.rdoc"]
